    ...
    static class BinarySearchTree {
        ...
        Node findInOrderSuccessor(Node inputNode) {
            ...
            if(inputNode.right != null){
                return getLeftmostOfRight(inputNode.right);
            }
            ...
            if(inputNode.parent.right == inputNode){
                return ancestorOfRight(inputNode);
            }

            return null;
        }

        Node ancestorOfRight(Node node){

            Node ancNode = node;
            while(ancNode != null && node.key >= ancNode.key){
                ancNode = ancNode.parent;
            }
            return ancNode ;
        }

        Node getLeftmostOfRight(Node node){
